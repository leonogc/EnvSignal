...
Before('@someMarkersBefore') do 
    ...
    marker2 = Marker.new(disaster_type: 'vazamento', latitude: 27.1232, longitude: -22.3323, user_id: (User.order("id").last).id, upvotes: 0, downvotes: 0, verified: true).save
    
    marker3 = Marker.new(disaster_type: 'vazamento', latitude: 37.1232, longitude: -32.3323, user_id: (User.order("id").last).id, upvotes: 0, downvotes: 0, verified: false).save
end
