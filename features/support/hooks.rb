...
Before('@someMarkersBefore') do 
    ...
    marker1 = Marker.new(disaster_type: 'incendio', latitude: 26.1232, longitude: -23.3323, user_id: 1, upvotes: 0, downvotes: 0, verified: false).save

    marker2 = Marker.new(disaster_type: 'vazamento', latitude: 27.1232, longitude: -22.3323, user_id: 1, upvotes: 0, downvotes: 0, verified: false).save
end
